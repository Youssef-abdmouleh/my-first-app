        ...
        <>
            <Box sx={{ flexGrow: 1 }}>
                <AppBar color={onTop ? 'transparent' : 'inherit'}>
                    <Toolbar>
                        <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}color="default"> E-shopping</Typography>
                        ...
                        <Button color="inherit" onClick={() => router.push('/products')}><ArticleIcon style={{color: 'red'}}/>Products</Button>
                    </Toolbar>
                </AppBar>
            </Box>
            <Toolbar />
